            ...
            {campaigns.map((campaign) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="break-all font-mono text-xs text-zinc-400">{campaign.code}</span>
                </div>
                ...
                <a
                  ...
                  className="mt-5 inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 sm:mt-auto sm:w-fit sm:self-start"
                >
                  Xem thiện pháp
